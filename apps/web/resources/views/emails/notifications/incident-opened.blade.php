...
@section('content')
    ...
    <p style="margin:16px 0 0;font-size:16px;line-height:26px;font-weight:500;color:#6B7D72;">
        {{ $notification->payload['description'] ?? $notification->body }}
    </p>
        ...
        <tr>
            <td style="border:1px solid #F7C7C7;border-radius:20px;background:#FFF5F5;padding:20px;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="padding:7px 0;font-size:13px;line-height:20px;font-weight:800;color:#8A9A90;">Ошибка</td>
                        <td align="right" style="padding:7px 0;font-size:13px;line-height:20px;font-weight:800;color:#D64545;">{{ $notification->payload['error'] ?? 'Проверка завершилась с ошибкой' }}</td>
                    </tr>
                    <tr>
                        <td style="padding:7px 0;font-size:13px;line-height:20px;font-weight:800;color:#8A9A90;">Начало</td>
                        <td align="right" style="padding:7px 0;font-size:13px;line-height:20px;font-weight:800;color:#26332D;">{{ $notification->payload['started_at_formatted'] ?? 'только что' }}</td>
                    </tr>
                </table>
            </td>
        </tr>
