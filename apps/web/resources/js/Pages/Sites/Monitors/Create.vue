...
<template>
    ...
    <main class="min-h-screen bg-neutral-950 text-white">
        ...
        <section class="mx-auto grid max-w-6xl gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[280px_1fr]">
            <aside class="rounded-lg border border-white/10 bg-neutral-900 p-4">
                ...
                <p v-if="form.errors.type" class="mt-3 text-sm text-red-300">
                    {{ form.errors.type }}
                </p>
            </aside>
